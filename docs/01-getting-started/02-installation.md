...
### Table of Contents
  ...
  2. **Installation**
  3. **Configuration**
  4. **Connecting to Codex**
  5. **Connecting to Google Gemini**
  6. **Connect to Cursor**
  7. **Metasploitable Full Lifecycle Demo**
...
#### **Specific Tooling & Technique Guides**
  ...
  * [**AI-Driven Web Application Pentesting with HexStrike-AI**](<https://medium.com/%401200km/ai-driven-web-application-pentesting-with-hexstrike-ai-961906961445>)
  ...
  * [**Integrating Shodan with HexStrike-AI Using Gemini-CLI**](<https://medium.com/%401200km/integrating-shodan-with-hexstrike-ai-using-gemini-cli-a18544c0649f>)
  * [**AI-Driven Wireless Penetration Testing. One Prompt WIFI cracking**](<https://medium.com/%401200km/ai-driven-wireless-penetration-testing-one-promt-wifi-cracking-16c80537237e>) (Using HexStrike-AI)
  * [**AI-Driven Office Documents Password Recovery with HexStrike-AI and Gemini-CLI**](<https://medium.com/%401200km/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli-4f1146747190>)
  * [**AI-Driven PDF Password Recovery with HexStrike-AI and Gemini-CLI**](<https://medium.com/%401200km/ai-driven-pdf-password-recovery-with-hexstrike-ai-and-gemini-cli-6e2101348873>)
  * [**AI-Driven ZIP Password Recovery with HexStrike-AI and Gemini-CLI**](<https://medium.com/%401200km/ai-driven-zip-password-recovery-with-hexstrike-ai-and-gemini-cli-9f37397b2756>)
...
On the Kali machine, HexStrike MCP command must exist:
  ...
  * It should be able to connect to the HexStrike server at `<http://127.0.0.1:8888>`
...
<https://medium.com/@1200km/hexstrike-cursor-mcp-from-single-target-full-subnet-compromise-lab-pt-walkthrough-f2e1fd793ad7>
