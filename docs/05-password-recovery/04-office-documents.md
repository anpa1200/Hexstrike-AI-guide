...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — From Encrypted Document to Readable Content Using LLM-Orchestrat…](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/0-NEMwBOBGpCmEwBNd.png)
...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — Inputs](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-kduNgL5-qOphNtjqD8Y5Gw.png)

  * Password Dictionary:  
`/path/to/wordlist.txt`

![AI driven office documents password recovery with HexStrike AI and Gemini CLI — Inputs (view 2)](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-lMl1ct5sA5HuWnB6xkYy6g.png)
...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — Step-by-Step Execution Flow](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-TogAVXnHW6s_p2I_SU9lUw.png)
...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — Step-by-Step Execution Flow (view 2)](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-KSvr7YDPe9YldkqTmp52rQ.png)
...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — 1) Task initiation (single high-level prompt)](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-lU5QSvvGyWBxHEsz1IC6xg.png)
...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — 4) Second failure: dependency not in PATH](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-PvX9xRmJWkkf2_3NJ9quIQ.png)
...
![AI driven office documents password recovery with HexStrike AI and Gemini CLI — 7) Success: password recovered](/img/hexstrike-articles/ai-driven-office-documents-password-recovery-with-hexstrike-ai-and-gemini-cli/1-39QwyfsDFB64CHq4YCLJag.png)
